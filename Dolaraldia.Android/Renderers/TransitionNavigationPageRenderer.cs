...
{
    public class TransitionNavigationPageRenderer : Xamarin.Forms.Platform.Android.AppCompat.NavigationPageRenderer
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == CustomControls.TransitionNavigationPage.TransitionTypeProperty.PropertyName)
        ...
        {
            var transitionNavigationPage = (CustomControls.TransitionNavigationPage)Element;
